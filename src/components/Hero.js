        ...
        <div class="container">
            <div class="row justify-content-center text-center">
                <div class="col-md-8">
                    ...
                    <p class="lead mb-4">I'm Sai Ganesh Kumar Chitturi, a Full Stack Python Developer. I have developed an Ethical Hacking projects using HTML, CSS, JavaScript, Django, and MySQL, focusing on building secure, dynamic, and responsive web applications.</p>
